"use strict";
(self["webpackChunktanstack_start_ts"] = self["webpackChunktanstack_start_ts"] || []).push([[140],{
...
/* harmony export */ });
/* harmony import */ var _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(368);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7697);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
/* harmony export */ });
/* harmony import */ var _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(368);
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8130);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7697);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/shared/aac-misc.js
var aac_misc = __webpack_require__(8657);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/codec.js
var codec = __webpack_require__(4350);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/codec-data.js
var codec_data = __webpack_require__(3751);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/demuxer.js
var demuxer = __webpack_require__(5020);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/misc.js
var misc = __webpack_require__(8130);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/packet.js
var src_packet = __webpack_require__(9538);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/isobmff/isobmff-misc.js
var isobmff_misc = __webpack_require__(1160);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/isobmff/isobmff-reader.js
var isobmff_reader = __webpack_require__(9207);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/reader.js
var src_reader = __webpack_require__(7697);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/metadata.js
var metadata = __webpack_require__(8991);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/shared/ac3-misc.js
var ac3_misc = __webpack_require__(4195);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/shared/bitstream.js
var shared_bitstream = __webpack_require__(368);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/aes.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/logging.js
var logging = __webpack_require__(9305);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/isobmff/isobmff-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
        ...
        switch (boxInfo.name) {
            ...
            case 'stsd':
                {
                    ...
                    for (let i = 0; i < entries; i++) {
                        ...
                        if (track.info.type === 'video') {
                            ...
                            else if (codec/* DTS_FOURCCS */.Sf.includes(codecName)) {
            ...
            case 'ddts':
                { // DTSSpecificBox
                    ...
                    (0,misc/* assert */.vA)(track.info?.type === 'audio');
                    const bytes = (0,src_reader/* readBytes */.io)(slice, Math.min(boxInfo.contentSize, codec_data/* DTS_SPECIFIC_BOX_SIZE */.Xc));
                    const config = (0,codec_data/* parseDtsSpecificBox */.ix)(bytes);
                    if (!config) {
                        logging/* Logging */.y._warn('Invalid ddts box contents, ignoring.');
                        break;
                    }
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            if (this.internalTrack.info.codec === 'dts' && !this.internalTrack.info.dtsFormat) {
                ...
                const firstPacket = await this.getFirstPacket({});
                this.internalTrack.info.dtsFormat = firstPacket && (0,codec_data/* extractDtsFourCcFromPacket */.n$)(firstPacket.data);
            }
            return {
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/matroska/ebml.js
var ebml = __webpack_require__(1809);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/matroska/matroska-misc.js
var matroska_misc = __webpack_require__(2358);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/matroska/matroska-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
            ...
            case ebml/* EBMLId */.Cl.TrackEntry:
                {
                    ...
                    if (this.currentTrack
                        ...
                        if (this.currentTrack.info.type === 'video'
                            ...
                            else if (codecIdWithoutSuffix === ebml/* CODEC_STRING_MAP */.oo.dts) {
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/shared/mp3-misc.js
var mp3_misc = __webpack_require__(4770);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/id3.js
var id3 = __webpack_require__(7114);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/mp3/mp3-reader.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
;// ./render-worker/node_modules/mediabunny/dist/modules/src/mp3/mp3-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/ogg/ogg-misc.js
var ogg_misc = __webpack_require__(9672);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/ogg/ogg-reader.js
var ogg_reader = __webpack_require__(1127);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/ogg/ogg-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/wave/wave-demuxer.js
var wave_demuxer = __webpack_require__(9210);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/adts/adts-reader.js
var adts_reader = __webpack_require__(6449);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/adts/adts-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/flac/flac-misc.js
var flac_misc = __webpack_require__(8346);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/flac/flac-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/mpeg-ts/mpeg-ts-misc.js
var mpeg_ts_misc = __webpack_require__(5504);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/mpeg-ts/mpeg-ts-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
                    ...
                    outer: if (elementaryStream && !elementaryStream.initialized) {
                        ...
                        if (elementaryStream.info.type === 'video') {
                            ...
                            if (elementaryStream.info.codec === 'aac') {
                                ...
                                const frameInfo = (0,codec_data/* parseDtsFrame */.CX)(context.suppliedPacket.data);
                                if (!frameInfo) {
            ...
            while (true) {
                ...
                while (this.currentPos - startPos < remaining) {
                    ...
                    if (codec === 'aac') {
                        ...
                        this.skip(-1);
                        const possibleSyncPos = this.currentPos;
                        let remaining = this.ensureBuffered(codec_data/* DTS_CORE_FRAME_HEADER_SIZE */.mB);
                        if (remaining instanceof Promise)
                            remaining = await remaining;
                        if (remaining < codec_data/* DTS_CORE_FRAME_HEADER_SIZE */.mB) {
                            return;
                        }
                        const headerBytes = this.readBytes(codec_data/* DTS_CORE_FRAME_HEADER_SIZE */.mB);
                        const core = (0,codec_data/* parseDtsCoreFrameHeader */.Wt)(headerBytes);
                        let leadingExss = core ? null : (0,codec_data/* parseDtsExssHeader */.Zt)(headerBytes);
                        if (!core && !leadingExss) {
                            this.seekTo(possibleSyncPos + 1);
                            continue;
                        }
                        if (leadingExss && !leadingExss.asset) {
                            ...
                            this.seekTo(possibleSyncPos);
                            const headerBound = Math.min(leadingExss.frameSize, codec_data/* DTS_EXSS_MAX_HEADER_SIZE */.$N);
                            let remaining = this.ensureBuffered(headerBound);
                            if (remaining instanceof Promise)
                                remaining = await remaining;
                            leadingExss = (0,codec_data/* parseDtsExssHeader */.Zt)(this.readBytes(remaining)) ?? leadingExss;
                        }
                        ...
                        if (core) {
                            ...
                            while (true) {
                                this.seekTo(possibleSyncPos);
                                const neededBytes = nextSubstreamPos + codec_data/* DTS_EXSS_HEADER_PREFIX_SIZE */.l9;
                                ...
                                const exss = (0,codec_data/* parseDtsExssHeader */.Zt)(this.readBytes(codec_data/* DTS_EXSS_HEADER_PREFIX_SIZE */.l9));
                                if (!exss) {
                                    break;
                                }
                        ...
                        if (remaining instanceof Promise)
                            remaining = await remaining;
                        const duration = Math.round(sampleCount * mpeg_ts_misc/* TIMESCALE */.cS / elementaryStream.info.sampleRate);
                        return this.supplyPacket(remaining, duration);
                    }
                    else {
                        throw new Error('Unhandled.');
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/hls/hls-misc.js
var hls_misc = __webpack_require__(4428);
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/input.js
var src_input = __webpack_require__(4120);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/segmented-input.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
// EXTERNAL MODULE: ./render-worker/node_modules/mediabunny/dist/modules/src/source.js
var source = __webpack_require__(9831);
;// ./render-worker/node_modules/mediabunny/dist/modules/src/hls/hls-segmented-input.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
;// ./render-worker/node_modules/mediabunny/dist/modules/src/hls/hls-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
;// ./render-worker/node_modules/mediabunny/dist/modules/src/input-format.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
/* harmony import */ var _codec_data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3751);
/* harmony import */ var _custom_coder_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2809);
/* harmony import */ var _logging_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9305);
/* harmony import */ var _media_sink_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5810);
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8130);
/* harmony import */ var _packet_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9538);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
/* harmony import */ var _input_format_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4184);
/* harmony import */ var _input_track_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8642);
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8130);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7697);
/* harmony import */ var _source_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9831);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
/* harmony export */ });
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8130);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
/* harmony export */ });
/* harmony import */ var _metadata_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8991);
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8130);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7697);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
...
/* harmony export */ });
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7697);
/* harmony import */ var _ogg_misc_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9672);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
/* harmony import */ var _input_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4120);
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8130);
/* harmony import */ var _source_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9831);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public

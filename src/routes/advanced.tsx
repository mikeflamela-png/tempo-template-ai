...
export const Route = createFileRoute("/advanced")({
  head: () => ({
    meta: [
      { title: "Advanced generator — Tempo" },
      {
        name: "description",
        content:
          "Full manual control over Tempo generation: prompt, aesthetic, pacing, typography, transitions and risk.",
      },
      { property: "og:title", content: "Advanced generator — Tempo" },

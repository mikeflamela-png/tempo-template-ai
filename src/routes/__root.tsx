...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Template Lab — AI social video templates" },
      {
        name: "description",
        content:
          "Generate animated short-form video editing templates, drop in your own clips, and keep the edit intact.",
      },
      { property: "og:title", content: "Template Lab" },
      {
        property: "og:description",
        content: "Generate animated short-form video editing templates in seconds.",
      },
